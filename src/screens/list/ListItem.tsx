...
const ListItem: React.FC<ListItemProps> = ({data, isGrid})=> {
    ...
    const itemWidth = isGrid ? (widthWithoutInset -36) /2: widthWithoutInset-24;
        ...
        >
            ...
            >
                ...
                <View style={{padding:8, flex:1}}>
                    <Text style={themeStyles(isDarkMode).listItemTitle} numberOfLines={2}>{item.name}</Text>
                    <Text style={themeStyles(isDarkMode).listItemDesc} numberOfLines={2}>{item.description}</Text>
                </View>
            </Pressable>
